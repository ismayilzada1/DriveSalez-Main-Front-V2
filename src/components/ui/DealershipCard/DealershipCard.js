...
const DealershipCard = ({imgSrc, description, phoneNumber, name, announcementNumber, isOfficial, onClick}) => {
    ...
    return (
        <div className={`mainCard ${theme === 'dark' ? 'dealership-card-dark' : ''}`}
             onClick={() => onClick({imgSrc, description, phoneNumber, name, announcementNumber, isOfficial})}>
          ...
          <span className="tooltip">{t("Official")}</span>
            ...
            <div className="dataContainer">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
                     className="bi bi-telephone" viewBox="0 2 16 13">
                    <path
