...
const AnnouncementDetailisSalon = ({
                                       isSalon,
                                       phoneNumber,
                                       SalonImage,
                                       salonName,
    ...
    return (
        <span>
        {isSalon ? (
            <div className={`salonMainDiv ${theme === 'dark' ? 'salon-contact-dark' : ''}`}>
                <div className="salonMainTop">
                    ...
                    <button className="callButtonTopSalon" onClick={handleButtonClick}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                             className="bi bi-telephone-fill" viewBox="0 0 16 17">
                    ...
                    <div className="salonMainBottom2">
                        <div className="salonMainBottomDate">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor"
                                 class="bi bi-clock-fill" viewBox="0 0 16 16" className="svgbottom">
                                <path
                        ...
                        <div className="salonMainBottomAdress">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 class="bi bi-geo-alt-fill" viewBox="0 0 16 16" className="svgbottom">
                                <path
            ...
            <div className={`UserDiv ${theme === 'dark' ? 'user-contact-dark' : ''}`}>
                ...
                <div className="UserDivBottom">
                    <button className="callButtonTopUser" onClick={handleButtonClick}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                             class="bi bi-telephone-fill" viewBox="0 0 16 17">
