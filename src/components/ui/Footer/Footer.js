...
const Footer=()=> {
    ...
    const currentYear = new Date().getFullYear();
        ...
        return (
            <footer className={`footer ${theme === 'dark' ? 'dark-mode-bg' : ''}`}>
                <div className="footer-body">
                    ...
                    <div className={`right-panel ${theme === 'dark' ? 'dark-theme-label' : ''}`}>
                        <p className={`footer-year`}>&copy; {currentYear}</p> {t('made_by')}
