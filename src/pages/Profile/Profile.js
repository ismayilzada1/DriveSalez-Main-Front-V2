...
import { setActiveTab } from '../../Store/ActiveTab/ActiveTabSlice';
            ...
            <div className="mt-3">
                <nav>
                    <div className="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                        ...
                        <button className="nav-link me-4" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false" onClick={() => handleTabClick('nav-profile-tab')}>
                            <svg className='me-2' width="27" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button className="nav-link me-4" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false" onClick={() => handleTabClick('nav-contact-tab')}>
                            <svg className='me-2' width="27" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
